...
const labels = {
  en: { weddingOf: "The wedding of", open: "Open Invitation", scroll: "Scroll", counting: "Counting the days", untilNikah: "until the DAY", celebrations: "Celebrations", events: "The Events", venue: "The Venue", moments: "Moments", gallery: "Us, so far", respond: "Kindly respond", rsvp: "RSVP", scan: "Scan to RSVP", directions: "Get directions", location: "View location", language: "Language" },
